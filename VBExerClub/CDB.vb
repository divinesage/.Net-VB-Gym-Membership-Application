...
Public Class CDB
    ...
    'Asking for a Store Procedure with an Array of Params
    ...
    'Asking for a Store Procedure with a Single Parm
    ...
    'Execute Store Procedure that don't return data to us, multiple params
    ...
    'Execute Store Procedure with single param
